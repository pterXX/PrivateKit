...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/PrivateKit"
  ...
  s.source       = { :git => "https://github.com/pterXX/PrivateKit.git", :tag => s.version.to_s }
  ...
  s.source_files  = "PrivateKit/PrivateKit/**/*.{h,m,swift}"
